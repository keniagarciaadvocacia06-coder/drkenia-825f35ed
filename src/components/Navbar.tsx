    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-[#d4b896] to-[#66503d] backdrop-blur-md border-b border-border/30">
      <div className="max-w-7xl mx-auto px-6 py-2 flex items-center justify-between">
        ...
        <a
          ...
          className="hidden lg:inline-flex px-6 py-2.5 bg-gradient-to-r from-[#8b6914] to-[#e8d090] text-primary-foreground text-sm font-medium rounded-sm hover:from-[#7a5c10] hover:to-[#d4bc7c] transition-all duration-300 tracking-wide"
        >
          FALE CONOSCO
        </a>
