  ...
  return (
    <section id="contato" className="py-24 px-6 bg-secondary">
      <div className="max-w-4xl mx-auto text-center">
        <p className="text-sm tracking-[0.3em] uppercase text-muted-foreground mb-4">Contato</p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          ...
          >
            ...
            <p className="text-muted-foreground text-sm">(64) 99988-1043</p>
          </a>
          ...
          >
            ...
            <h3 className="font-heading text-xl text-foreground mb-2">E-mail</h3>
            <p className="text-muted-foreground text-sm">keniagarcia.advocacia@gmail.com</p>
          </a>

          <div className="bg-card border border-border rounded-sm p-8">
            <MapPin className="w-8 h-8 text-primary mx-auto mb-4" strokeWidth={1.5} />
            <h3 className="font-heading text-xl text-foreground mb-2">Atendimento</h3>
            <p className="text-muted-foreground text-sm">Presencial e Online — Todo o Brasil</p>
          </div>
        </div>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 px-10 py-4 bg-primary text-primary-foreground font-medium rounded-sm hover:bg-gold-light transition-colors duration-300 tracking-wide text-sm"
        >
